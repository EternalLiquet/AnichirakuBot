...
const inactivity_handler_1 = require("../bot/services/inactivity-handler");
...
container.bind(types_1.TYPES.InactivityHandler).to(inactivity_handler_1.InactivityHandler).inSingletonScope();
